...
export default class DiaryMaintain extends Component {
  ...
  fetchUserDetails() {
    ...
    photosRef
      .where('email', '==', this.props.screenProps.email)
      .get()
    ...
    return (
      <>
        <View style={main.header}>
          <Text style={main.inputText}>Diary</Text>
        </View>
        {/* <Header
          ...
          <View
            ...
            {this.state.loading == true ? (
              ...
              <MasonryList
                ...
                onPressImage={item =>
                  this.props.screenProps.navigateToOther.navigate('mainFeed', {
                    selectedItem: item,
                    email: this.props.screenProps.email.trim(),
                    isDiary: true,
                  })
                }
                onLongPressImage={(item, index) =>
